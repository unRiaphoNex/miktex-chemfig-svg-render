...
const FILES = [
  ...
  "features/learning/knowledge-relation-network.ts", // 知识点关联网络 (v17.2.0)
  "features/learning/knowledge-search-engine.ts", // 知识库搜索优化 (v17.2.0)
  "features/learning/smart-learning-recommender.ts", // 智能学习推荐 (v17.2.0)
  ...
  "features/learning/molecule-comparison.ts", // 分子结构比较 (v17.4.0)
  "features/learning/trajectory-player.ts", // 分子轨迹播放器 (v17.4.0)
  "features/learning/structure-2d-renderer.ts", // 2D结构渲染器 (v17.5.0)
  "features/learning/knowledge-link-manager.ts", // 知识关联系统 (v17.5.0)
  "features/learning/external-chem-database.ts", // 外部化学数据库 (v17.5.0)
  "features/learning/ngl-viewer.ts", // NGL大分子查看器 (v17.5.0)
  // ========== features: chemistry/ ==========
  ...
  "integrations/ocl-global-map.js",
  "integrations/3dmol-min.js",        // 3Dmol.js (IIFE 全局, 原样拷贝, 不依赖网络)  // 将 OpenChemLib 映射到 OCL 全局变量
